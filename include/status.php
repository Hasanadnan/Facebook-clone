  ...
  <div class="status-wrap">
    ...
    <div class="status-med">
      ...
      <div class="status-prof-textarea" style="position:relative;">
        <textarea name="textStatus" id="statusEmoji" cols="5" rows="5" class="status align-middle"
    ...
    <div class="status-bot">
      <div class="file-upload-remIm input-restore">
        ...
        <input type="file" name="post-file-upload" id="multiple_files" class="file-upload-input postImage"
