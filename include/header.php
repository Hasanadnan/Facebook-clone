      ...
      <div class="top-right-part">
        ...
        <div class="request-top-notification top-css top-icon border-left " style="position:relative;">
          ...
          <div class="request-notification-list-wrap">
            ...
            <ul style="margin:0; padding:0;" class="notify-ul">
              ...
              <li
                class="item-notification-wrap <?php echo ($notify->status == '0') ? 'unread-notification' : 'read-notification' ?>"
                data-postid="<?php echo $notify->postid; ?>" data-notificationid="<?php echo $notify->ID; ?>"
                ...
                <a href="<?php echo $notify->userLink; ?>" target="_blank" class="item-notification">
                  ...
                  <a href="post.php?username=<?php echo $notify->userLink; ?>&postid=<?php echo $notify->postid; ?>&profileid=<?php echo $notify->userId; ?>"
                    target="_blank" class="item-notification">
                    <?php } ?>
                    <img src="<?php echo $notify->profilePic; ?>" style="height:40px; width:40px; border-radius:50%;"
                      alt="">
        ...
        <a href="messenger.php" class="message-top-notification">
          ...
          <div class="top-messenger top-css top-icon border-left " style="position:relative;">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="message-svg" style="height:20px; width:20px;"
              viewBox="0 0 12.64 13.64">
              <defs>
                <style>
                .cls-1 {
                  fill: #1a2947;
        ...
        <div class="top-notification top-css top-icon border-left " style="position: relative;">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="notification-svg" style="height:20px; width:20px;"
            viewBox="0 0 12.06 13.92">
            <defs>
              <style>
              .cls-1 {
                fill: #1a2947;
        ...
        <div class="top-help top-css top-icon border-left ">
          <svg xmlns="http://www.w3.org/2000/svg" class="help-svg" style="height:20px; width:20px;"
        ...
        <div class="top-more top-css top-icon border-left ">
          <div class="watchmore-wrap">
            <svg xmlns="http://www.w3.org/2000/svg" class="more-svg" style="height:20px; width:20px;"
              viewBox="0 0 14.54 6.57">
              <defs>
                <style>
                .cls-1 {
                  fill: #1a2947;
          ...
          <div class="setting-logout-wrap" style="position:relative;margin-top: 41px;display:none;">
            <div class="s-1-wrap"
              style="position:absolute;background-color:white;color:gray;padding: 10px 10px; box-shadow: 0 0 5px gray; border-radius: 2px;    margin-left: -60px;">
