...
<body>
  ...
  <div class="main" style="width:100%;">
    ...
    <div class="right-side">
      ...
      <form action="sign.php" method="post" name="user-sign-up" id="formAdd">
        <div class="sign-up-form">
          <div class="sign-up-name">
            <input type="text" name="first" id="first" class="text-field" placeholder="First Name"
              value="<?= htmlspecialchars($upFirst) ?>" required>
            <input type="text" name="last" id="last" placeholder="Last Name" class="text-field"
              value="<?= htmlspecialchars($upLast) ?>" required>
          </div>
          <div class="sign-wrap-mobile">
            <input type="text" name="email" id="up-email" placeholder="Mobile number or email address"
              class="text-input" value="<?= htmlspecialchars($upEmailMobile) ?>" required>
          </div>
