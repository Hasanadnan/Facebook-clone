      ...
      ?>
        <div class="user-block-show-wrap" style="display: flex;justify-content: center;width: 100%;">
          <div class="user-block-show" style="margin-top:50px; border:1px solid gray; border-radius:10px;background-color:white;padding:20px; ">
            ...
            <hr>
            <div style="font-size:13px; font-weight:300;">The link you followed may have expired, or the page may only be
              visible to an audience you are not in.</div> <br>
            ...
            <div class="bio-wrap">
              <div class="bio-intro">
                ...
                <div class="bio-feature">
                  ...
                  <div class="feat-text">
                    Showcase what's important to you by adding people, pages, groups and more to your featured section on
                    your public profile.
                  </div>
    ...
    $(function() {
      ...
      $(document).on('keyup', '.emojionearea-editor', function() {
        ...
        if (regex_text != null) {
          ...
          $.post('http://localhost:8080/facebook/core/ajax/hashtag_mention.php', {
      ...
      $(document).on('click', '.block-show', function() {
        ...
        $.post('http://localhost:8080/facebook/core/ajax/block.php', {
          profileid: profileid,
          userid: userid
        }, function(data) {
          location.reload();
      ...
      var BASE_URL = "http://localhost:8080/facebook/";

      function notificationUpdate(userid) {
        $.post('http://localhost:8080/facebook/core/ajax/notify.php', {
      ...
      $(document).on('change', '#profile-upload', function() {
        ...
        if (name != '') {
          $.post('http://localhost:8080/facebook/core/ajax/profilePhoto.php', {
            imgName: imgName,
            userid: userid
          }, function(data) {
            //                            $('#adv_dem').html(/data);
          ...
          $.ajax({
            url: 'http://localhost:8080/facebook/core/ajax/profilePhoto.php',
            cache: false,
            contentType: false,
            processData: false,
            data: form_data,
      ...
      $('#cover-upload').on('change', function() {
        ...
        if (name != '') {
          $.post('http://localhost:8080/facebook/core/ajax/profile.php', {
            imgName: imgName,
            userid: userid
          }, function(data) {
            //                            alert(data);
        ...
        $.ajax({
          url: 'http://localhost:8080/facebook/core/ajax/profile.php',
          cache: false,
          contentType: false,
          processData: false,
          data: form_data,
      ...
      $(document).on("change", "#multiple_files", function(e) {
        ...
        $.each(files, function(i, file) {
          ...
          reader.onload = function(e) {
            ...
            var template = '<li class="ui-state-default del" style="position:relative;"><img id="' + name +
              '" style="width:60px; height:60px" src="' + e.target.result + '"></li>';
      ...
      $('.status-share-button').on('click', function() {
        ...
        if (files.length != 0) {
          ...
          if (error_images == '') {
            $.ajax({
              url: 'http://localhost:8080/facebook/core/ajax/uploadPostImage.php',
              method: "POST",
              data: formData,
              contentType: false,
              cache: false,
              processData: false,
              beforeSend: function() {
                $('#error_multiple_files').html('<br/><label> Uploading Loading...</label>');
              },
              success: function(data) {
        ...
        if (stIm == '') {
          $.post('http://localhost:8080/facebook/core/ajax/postSubmit.php', {
      ...
      $(document).on('click', '.postImage', function() {
        ...
        $.post('http://localhost:8080/facebook/core/ajax/imgFetchShow.php', {
          fetchImgInfo: userid,
          postid: postid,
          imageSrc: imageSrc
        }, function(data) {
          ...
          $('.comment-submit').keyup(function(e) {
            if (e.keyCode == 13) {
              ...
              if (comment == '') {
                ...
                $.ajax({
                  type: "POST",
                  url: "http://localhost:8080/facebook/core/ajax/comment.php",
                  data: {
                    comment: comment,
                    userid: userid,
                    postid: postid,
      ...
      $(document).on('click', '.post-option', function() {
        ...
        $(postDetails).show().html('<div class="post-option-details"><ul><li class="post-edit" data-postid="' +
          postid + '" data-userid="' + userid + '">Edit</li><li class="post-delete" data-postid="' + postid +
          '" data-userid="' + userid + '">Delete</li><li class="post-privacy" data-postid="' + postid +
      ...
      $(document).on('click', 'li.post-edit', function() {
        ...
        $('.top-box-show').html(
          ...
          postid + '" data-userid="' + userid + '" data-tag="' + thiss + '">Save</div> </div> </div>');
      ...
      $(document).on('click', '.edit-post-save', function() {
        ...
        $.post('http://localhost:8080/facebook/core/ajax/editPost.php', {
      ...
      function mainReactSubmit(typeR, postId, userId, nf_3) {
        var profileid = p_id;
        $.post('http://localhost:8080/facebook/core/ajax/react.php', {
          reactType: typeR,
          postId: postId,
          userId: userId,
          profileid: profileid
      ...
      $('.like-action-wrap').hover(function() {
        ...
        $(mainReact).html(
          ' <div class="react-bundle align-middle" style="position:absolute;margin-top: -43px; margin-left: -40px; display:flex; background-color:white;padding: 0 2px;border-radius: 25px; box-shadow: 0px 0px 5px black; height:45px; width:270px; justify-content:space-around; transition: 0.3s;"> <div class="like-react-click align-middle"> <img class="main-icon-css" src="' +
          BASE_URL +
          'assets/image/react/like.png " alt=""></div> <div class="love-react-click align-middle"> <img class="main-icon-css" src="' +
          BASE_URL +
          'assets/image/react/love.png " alt=""></div> <div class="haha-react-click align-middle"> <img class="main-icon-css" src="' +
          BASE_URL +
          'assets/image/react/haha.png " alt=""></div> <div class="wow-react-click align-middle"> <img class="main-icon-css" src="' +
          BASE_URL +
          'assets/image/react/wow.png " alt=""></div> <div class="sad-react-click align-middle"> <img class="main-icon-css" src="' +
          BASE_URL +
          'assets/image/react/sad.png " alt=""></div> <div class="angry-react-click align-middle"> <img class="main-icon-css" src="' +
          BASE_URL + 'assets/image/react/angry.png " alt=""></div> </div>');
      }, function() {
        var mainReact = $(this).find('.react-bundle-wrap');
        $(mainReact).html('');
      })
      ...
      function commentHover() {
        ...
        $('.com-like-react').hover(function() {
          ...
          $(mainReact).html(
            ...
            BASE_URL +
            'assets/image/react/like.png " alt=""></div><div class="com-love-react-click align-middle"><img class="com-main-icon-css" src="' +
            BASE_URL +
            'assets/image/react/love.png " alt=""></div><div class="com-haha-react-click align-middle"><img class="com-main-icon-css" src="' +
            BASE_URL +
            'assets/image/react/haha.png " alt=""></div><div class="com-wow-react-click align-middle"><img class="com-main-icon-css" src="' +
            BASE_URL +
            'assets/image/react/wow.png " alt=""></div><div class="com-sad-react-click align-middle"><img class="com-main-icon-css" src="' +
            BASE_URL +
            'assets/image/react/sad.png " alt=""></div><div class="com-angry-react-click align-middle"><img class="com-main-icon-css" src="' +
            BASE_URL + 'assets/image/react/angry.png " alt=""></div></div>');
        }, function() {
          var mainReact = $(this).find('.com-react-bundle-wrap');
          $(mainReact).html('');
      ...
      function comReactSubmit(typeR, postid, userid, commentID, com_nf_3) {
        var profileid = p_id;
        $.post('http://localhost:8080/facebook/core/ajax/commentReact.php', {
            commentid: commentID,
            reactType: typeR,
            postid: postid,
            userid: userid,
      ...
      $(document).on('click', '.com-dot', function() {
        ...
        $(comDetails).show().html(
          '<div class="com-option-details" style="z-index:2;"><ul><li class="com-edit" data-postid="' + postid +
          '" data-userid="' + userid + '" data-commentid="' + commentid +
          '">Edit</li><li class="com-delete" data-postid="' + postid + '" data-userid="' + userid +
          '" data-commentid="' + commentid + '">Delete</li><li class="com-privacy" data-postid="' + postid +
          '" data-userid="' + userid + '">privacy</li></ul></div>');
      })
      ...
      $(document).on('click', 'li.com-edit', function() {
        ...
        $('.top-box-show').html(
          ...
          postid + '" data-userid="' + userid + '" data-commentid="' + commentid + '" >Save</div></div></div>');
      })
      ...
      $(document).on('click', '.edit-com-save', function() {
        ...
        var editedTextVal = $(editedText).val();
        $.post('http://localhost:8080/facebook/core/ajax/editComment.php', {
          postid: postid,
          userid: userid,
          editedTextVal: editedTextVal,
          commentid: commentid
      ...
      $(document).on('click', '.com-reply-action', function() {
        ...
        input_field.html(
          '<div class="reply-write"><div class="com-pro-pic" style="margin-top: 4px;"><a href="#"><div class="top-pic"><img src="' +
          profilepic +
        ...
        $('input.reply-input-style.reply-submit').keyup(function(e) {
          if (e.keyCode == 13) {
            ...
            if (comment == '') {
              ...
              $.ajax({
                type: "POST",
                url: "http://localhost:8080/facebook/core/ajax/reply.php",
                data: {
      ...
      function replyReactSubmit(typeR, postid, userid, commentID, commentparentid, com_nf_3) {
        var profileid = p_id;
        $.post('http://localhost:8080/facebook/core/ajax/replyReact.php', {
          commentid: commentID,
          reactType: typeR,
          postid: postid,
          userid: userid,
      ...
      $(document).on('click', '.reply-dot', function() {
        ...
        $(replyDetails).html(
          ...
          postid + '" data-userid="' + userid + '" data-commentid="' + commentid +
          '">Edit</li><li class="reply-delete" data-postid="' + postid + '" data-userid="' + userid +
          '" data-commentid="' + commentid + '" data-replyid="' + replyid +
          '">Delete</li><li class="reply-privacy" data-postid="' + postid + '" data-userid="' + userid +
          '">privacy</li></ul></div>');
      })
      $(document).on('click', 'li.reply-edit', function() {
        ...
        $('.top-box-show').html(
          ...
          postid + '" data-userid="' + userid + '" data-commentid="' + commentid + '" data-replyid="' +
          replyid + '">Save</div></div></div>');
      ...
      $(document).on('click', '.edit-reply-save', function() {
        ...
        $.post('http://localhost:8080/facebook/core/ajax/editReply.php', {
          postid: postid,
          userid: userid,
          editedTextVal: editedTextVal,
          commentid: commentid,
      ...
      $(document).on('click', '.share-action', function() {
        ...
        $('.top-box-show').html(
          '<div class="top-box profile-dialog-show" style="overflow: hidden;background-color: rgb(236, 236, 236);"> <div class="edit-post-header align-middle " style="justify-content: space-between; padding: 10px; height: 20px; background-color: lightgray;font-size: 14px; font-weight:600; "> <div class="edit-post-text">Share Post</div> <div class="edit-post-close" style="padding: 5px; color: gray; cursor:pointer;">x</div> </div> <div class="edit-post-value" style=""> <div class="status-med"> <div class="status-prof"> <div class="top-pic"><img src="' +
          profilePic +
          '" alt=""></div> </div> <div class="status-prof-textarea"> <textarea data-autoresize rows="5" columns="5" placeholder="Tell something about the post.." name="textStatus" class="shareText align-middle" style="padding-top: 10px;"></textarea> </div> </div> </div> <div class="news-feed-text" style=" display: flex; flex-direction: column; align-items: baseline; margin:5px;box-shadow:0 0 2px darkgray;overflow: hidden;"> ' +
          nf_1 + ' ' + nf_2 +
          ' </div> <div class="edit-post-submit" style="position: absolute;right:0; bottom: 0; display: flex; align-items: center; margin: 10px; z-index: 1;"> <div class="status-privacy-wrap"> <div class="status-privacy " style="background-color: #f5f6f8;"> <div class="privacy-icon align-middle"> <img src="assets/image/profile/publicIcon.JPG" alt=""> </div> <div class="privacy-text">Public</div> <div class="privacy-downarrow-icon align-middle"> <img src="assets/image/watchmore.png" alt=""> </div> </div> <div class="status-privacy-option"> </div> </div> <div class="post-Share" style="padding: 3px 15px; background-color: #4267bc;color: white; font-size: 14px; margin-left:5px;cursor:pointer;" data-postid="' +
          postid + '" data-userid="' + userid + '" data-profileid="' + profileid +
          '" >Share</div> </div> <div style=" position: absolute; bottom: 0; height: 43px; width: 100%; text-align: center; background: lightgrey;box-shadow: -1px -1px 5px grey;"></div> </div>'
        );
      ...
      $(document).on('click', '.post-Share', function() {
        ...
        var userid = $(this).data('userid');
        var profileid = $(this).data('profileid');
        var shareText = $(this).parents('.edit-post-submit').siblings('.edit-post-value').find('.shareText')
          .val();

        $.post('http://localhost:8080/facebook/core/ajax/share.php', {
          shareText: shareText,
          profileid: profileid,
          postid: postid,
          userid: userid
      ...
      $(document).on('click', '.share-container', function() {
        ...
        window.location.href = "http://localhost:8080/facebook/profile.php?username=" + userLink + "";
      })
      $(document).on('click', '.shared-post-option', function() {
        ...
        $(postDetails).show().html(
          ...
          postid + '" data-userid="' + userid + '">Edit</li><li class="shared-post-delete" data-postid="' +
          postid + '" data-userid="' + userid + '">Delete</li><li class="post-privacy" data-postid="' + postid +
          '" data-userid="' + userid + '">privacy</li></ul></div>');
      })
      ...
      $(document).on('click', 'li.shared-post-edit', function() {
        ...
        $('.top-box-show').html(
          '<div class="top-box profile-dialog-show" style="top: 12.5%;left: 22.5%;width: 55%;"><div class="edit-post-header align-middle " style="justify-content: space-between; padding: 10px; height: 20px; background-color: lightgray;font-size: 14px; font-weight:600; "><div class="edit-post-text">Edit Post</div><div class="shared-edit-post-close" style="padding: 5px; color: gray; cursor:pointer;">x</div></div><div class="edit-post-value" style="border-bottom: 1px solid lightgray;"><div class="status-med"><div class="status-prof"><div class="top-pic"><img src="' +
          profilepic +
          '" alt=""></div></div><div class="status-prof-textarea"><textarea data-autoresize rows="5" columns="5" placeholder="" name="textStatus" class="sharedEditStatus align-middle" style="font-family:sens-serif; font-weight:400; padding:5px;">' +
          getPostText +
      ...
      $(document).on('click', '.shared-edit-post-save', function() {
        ...
        var editedText = $(this).parents('.edit-post-submit').siblings('.edit-post-value').find(
          '.sharedEditStatus');
        var editedTextVal = $(editedText).val();
        $.post('http://localhost:8080/facebook/core/ajax/sharedEditPost.php', {
          sharedPostid: postid,
          userid: userid,
          editedTextVal: editedTextVal
        }, function(data) {
      ...
      $(document).on('keyup', 'input#main-search', function() {
        ...
        if (searchText == '') {
          ...
          $.post('http://localhost:8080/facebook/core/ajax/search.php', {
      ...
      $(document).on('click', '.profile-add-friend', function() {
        ...
        $.post('http://localhost:8080/facebook/core/ajax/request.php', {
          request: profileid,
          userid: userid
        }, function(data) {
      ...
      $(document).on('click', '.profile-friend-sent', function() {
        $(this).parents('.profile-action').find('.profile-unfollow-button').removeClass().addClass(
          'profile-unfollow-button').html(
      ...
      $(document).on('click', '.profile-follow-button', function() {
        $(this).removeClass().addClass('profile-unfollow-button').html(
          ' <img src="assets/image/rightsignGray.JPG" alt=""><div class="profile-activity-button-text">Following</div>'
        );
        var userid = $(this).data('userid');
        var profileid = $(this).data('profileid');
      ...
      $(document).on('click', '.profile-unfollow-button', function() {
        $(this).removeClass().addClass('profile-follow-button').html(
          ' <img src="assets/image/followGray.JPG" alt=""><div class="profile-activity-button-text">Follow</div>'
        );
        var userid = $(this).data('userid');
        var profileid = $(this).data('profileid');
