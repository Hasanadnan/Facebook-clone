$(function () {
  ...
  function notificationUpdate(userid) {
    $.post(
      'http://localhost:8080/facebook/core/ajax/notify.php',
      {
  ...
  $(document).on('change', '#profile-upload', function () {
    ...
    if (name != '') {
      $.post(
        'http://localhost:8080/facebook/core/ajax/profilePhoto.php',
        {
          imgName: imgName,
          userid: userid,
        },
  ...
  $('#cover-upload').on('change', function () {
    ...
    if (name != '') {
      $.post(
        'http://localhost:8080/facebook/core/ajax/profile.php',
        {
          imgName: imgName,
          userid: userid,
        },
  ...
  $('.status-share-button').on('click', function () {
    ...
    if (stIm == '') {
      $.post(
        'http://localhost:8080/facebook/core/ajax/postSubmit.php',
        {
  ...
  $(document).on('click', '.postImage', function () {
    ...
    $.post(
      'http://localhost:8080/facebook/core/ajax/imgFetchShow.php',
      {
        fetchImgInfo: userid,
        postid: postid,
        imageSrc: imageSrc,
      ...
      function (data) {
        ...
        $(document).on('click', '.comment-action', function () {
          $(this)
            .parents('.nf-4')
            .siblings('.nf-5')
            .find('input.comment-input-style.comment-submit')
            .focus()
        })
    ...
    $(postDetails)
      ...
      .html(
        '<div class="post-option-details"><ul><li class="post-edit" data-postid="' +
          ...
          '" data-userid="' +
          userid +
          '">Edit</li><li class="post-delete" data-postid="' +
          postid +
          '" data-userid="' +
          userid +
  ...
  $(document).on('click', '.edit-post-save', function () {
    ...
    $.post(
      'http://localhost:8080/facebook/core/ajax/editPost.php',
      {
  ...
  function mainReactSubmit(typeR, postId, userId, nf_3) {
    var profileid = p_id
    $.post(
      'http://localhost:8080/facebook/core/ajax/react.php',
      {
        reactType: typeR,
        postId: postId,
        userId: userId,
  ...
  function comReactSubmit(typeR, postid, userid, commentID, com_nf_3) {
    var profileid = p_id
    $.post(
      'http://localhost:8080/facebook/core/ajax/commentReact.php',
      {
        commentid: commentID,
        reactType: typeR,
        postid: postid,
  ...
  $(document).on('click', '.edit-com-save', function () {
    ...
    var editedTextVal = $(editedText).val()
    $.post(
      'http://localhost:8080/facebook/core/ajax/editComment.php',
      {
        postid: postid,
        userid: userid,
        editedTextVal: editedTextVal,
  ...
  function replyReactSubmit(
    ...
    var profileid = p_id
    $.post(
      'http://localhost:8080/facebook/core/ajax/replyReact.php',
      {
        commentid: commentID,
        reactType: typeR,
        postid: postid,
  ...
  $(document).on('click', '.edit-reply-save', function () {
    ...
    $.post(
      'http://localhost:8080/facebook/core/ajax/editReply.php',
      {
        postid: postid,
        userid: userid,
        editedTextVal: editedTextVal,
  ...
  $(document).on('click', '.post-Share', function () {
    ...
    $.post(
      'http://localhost:8080/facebook/core/ajax/share.php',
      {
        shareText: shareText,
        profileid: profileid,
        postid: postid,
  ...
  $(document).on('click', '.share-container', function () {
    ...
    window.location.href =
      'http://localhost:8080/facebook/profile.php?username=' + userLink + ''
  })
  ...
  $(document).on('click', '.shared-edit-post-save', function () {
    ...
    var editedTextVal = $(editedText).val()
    $.post(
      'http://localhost:8080/facebook/core/ajax/sharedEditPost.php',
      {
        sharedPostid: postid,
        userid: userid,
        editedTextVal: editedTextVal,
  ...
  $(document).on('keyup', 'input#main-search', function () {
    ...
    if (searchText == '') {
      ...
      $.post(
        'http://localhost:8080/facebook/core/ajax/search.php',
        {
  ...
  $(document).on('click', '.profile-add-friend', function () {
    ...
    $.post(
      'http://localhost:8080/facebook/core/ajax/request.php',
      {
        request: profileid,
        userid: userid,
      },
