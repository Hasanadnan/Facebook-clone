    ...
    <div class="first-section">
      <div class="active-wrap top-pic-name-wrap   ">
        <a href="profile.php" class="top-pic-name">
          ...
          <div class="top-name top-css" style="color:black;">Hasan</div>
        </a>
      </div>
      <br>
    ...
    <div class="third-section">
      <div class="story-wrap">
        ...
        <a href="">
          <div class="user-story">
            ...
            <div class="story-profile-wrap">
              <div class="story-profile-name">Raihan Md Abu Masum</div>
        ...
        <a href="">
          <div class="user-story">
            ...
            <div class="story-profile-wrap">
              <div class="story-profile-name">Shaon Islam</div>
        ...
        <a href="">
          <div class="user-story">
            ...
            <div class="story-profile-wrap">
              <div class="story-profile-name">Sagor Khan</div>
              <div class="story-profile-time">1 hours ago</div>
            </div>
          </div>
        </a>
      ...
      <div class="birthday-wrap">
        <a href="" class="birthday-gift">
          ...
          <div class="birth-name-wrap"><span class="birth-name">Mahir Shishir</span><span class="birth-date">'s birthday
              today</span></div>
        </a>
      </div>
      <div class="friend-request-wrap">
        ...
        <div class="friend-request-user">
          ...
          <div class="request-name-conf">
            <div class="req-name">Angel Rahim</div>
            <div class="req-conf">
        ...
        <div class="friend-request-user">
          ...
          <div class="request-name-conf">
            <div class="req-name">Rock Boy Mofiz</div>
            <div class="req-conf">
              <div class="req-conf-yes">Confirm</div>
              <div class="req-conf-del">Delete</div>
            </div>
        ...
        <div class="friend-request-user">
          ...
          <div class="request-name-conf">
            <div class="req-name">I am Legend</div>
            <div class="req-conf">
              <div class="req-conf-yes">Confirm</div>
              <div class="req-conf-del">Delete</div>
            </div>
